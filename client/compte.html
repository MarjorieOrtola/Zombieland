...
<header class="header">
    ...
    <main class="main">
        <section class="main__compte">
            ...
            <p class="compte__text">Ici relier les informations du compte utilisateur lors de l'inscription (nom, prénom, email, mot de passe) avec possibilité de les modifier.
            </p>
            <p class="compte__text">Ici ajouter la liste des billets par date d'entrée avec possibilité de les télécharger et supprimer (si date d'entrée > 10 jours).
            </p>
        </section>
    </main>
